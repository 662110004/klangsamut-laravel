        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.books.admin_index')" :active="request()->routeIs('admin.books.*')">
                        {{ __('Manage Books') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                @auth
                @if(Auth::user()->role == 'admin')
                <x-responsive-nav-link :href="route('admin.books.admin_index')" :active="request()->routeIs('admin.books.*')">
                    {{ __('Manage Books') }}
                </x-responsive-nav-link>
